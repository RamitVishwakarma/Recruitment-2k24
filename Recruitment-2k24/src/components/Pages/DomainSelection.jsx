...
export default function DomainSelction(){
    return(
        ...
        <h1 className="text-8xl w-[69.25rem] font-Zodiac text-header m-auto text-center font-bold p-[1rem]">Choose a domain to get started</h1>
        ...
        <Domain icon={Ml} text={"Machine Learning"}/>
